...
title: "多线程学习之龟兔赛跑"
date: 2021-05-28
description: "龟兔赛跑问题 模拟龟兔竞争冠军 兔子睡觉过程。以下是代码：public class Race implements Runnable{    private static String winner;    @Override    public void run() {        for (int i = 0; i <= 100; i++) {            if (Thread.c"
tags:
  - CSDN迁移
---
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/0a0030c2d513ac3968bcabe46b6842e7.png)
