...
title: "初学算法之分治---求逆序数"
date: 2021-07-11
description: "package 分治;/** * @ClassName 求排列的逆序数 * @Author ACER * @Description * 对于261数组，有逆序数（6，1） * 给定一个数组 求其 * 逆序数 * @Date 2021/7/11 10:25 * @Version 1.0 **/public class 求排列的逆序数 {    public static void main(Stri"
tags:
  - CSDN迁移
---
