...
date: 2025-06-15
description: "太监宣旨”→ 注解写在类上，反射器执行“圣旨”。创建一个圣旨@Inherited宣读圣旨（放在类上）int age;执行圣旨（反射器调用）// 遍历类上所有的注解，找到我们的圣旨！// invoketry {注解只是一段信息注解不是具体的处理逻辑处理逻辑由其他代码实现。"
tags:
  - CSDN迁移
---
...
“太监宣旨”→ 注解写在类上，反射器执行“圣旨”。
  ...
  * 结果：  
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/36abf6f19dd34a9ebc78e9ea6f536375.png)
...
– 搭建方法见[编译Spring](<https://blog.csdn.net/weixin_46050018/article/details/145515735?spm=1001.2014.3001.5501>)
  * 创建一个项目如下：  
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/f7034efed4504554a1a0853b1581601a.png)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/6012b6d2f62c4e96952777c821a9a437.png)  
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/933f5dc880114640b041da0be4ba66b1.png)  
