...
title: "最大堆的删除"
date: 2020-04-09
description: "#include <stdio.h>#include <stdlib.h>typedef struct heapstruct {	elementtype *elements;//存放堆元素的数组	int size;//堆得当前元素个数	int capacity;//堆的最大容量 }*maxheap;maxheap create(int maxsize){//创..."
tags:
  - CSDN迁移
---
