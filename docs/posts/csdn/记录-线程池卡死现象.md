...
title: "【记录】线程池卡死现象"
date: 2024-11-14
description: "在funA中异步调用funB，由于大量的funA耗尽线程池中的线程，funB一直在等待funB中的任务完成，将funB中的任务放入阻塞队列，但是已经无线程可以使用，无人处理，于是造成了funA等待funB完成，fanB等待其中任务完成，最终导致卡死。在使用线程池时，错误的将completableFuture当成一种银弹，导致线程池卡死。"
tags:
  - CSDN迁移
---
